...
description_file = os.path.join(script_dir, "/content/item_description.json")
image_folder = os.path.join(script_dir, "/content/candiates")
output_path = os.path.join(script_dir, "/content/outfit_transformer/src/run/my_clip_embeddings.pkl")
